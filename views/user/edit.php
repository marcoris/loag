<div class="jumbotron jumbotron-fluid">
    ...
    <form action="<?php echo URL; ?>user/editSave/<?php echo $this->user[0]['employeeid']; ?>" method="post">
        ...
        <label for="name">Vorname:<span class="required-star">*</span></label><input type="text" id="name" name="name" value="<?php echo $this->user[0]['firstname']; ?>"><br>
        <label for="surname">Name:<span class="required-star">*</span></label><input type="text" id="surname" name="surname" value="<?php echo $this->user[0]['lastname']; ?>"><br>
        ...
        foreach($this->categoryData as $key => $value) {
            ...
            if($this->user[0]['category'] == $value['category_id']) {
                echo 'selected';
            }
        ...
        foreach($this->absenceData as $key => $value) {
            ...
            if($this->user[0]['absence'] == $value['absence_id']) {
                echo 'selected';
            }
        ...
        foreach($this->roleData as $key => $value) {
            ...
            if($this->user[0]['role'] == $value['role_id']) {
                echo 'selected';
            }
